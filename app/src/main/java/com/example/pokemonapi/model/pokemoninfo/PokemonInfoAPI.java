...
public class PokemonInfoAPI {
    ...
    @TypeConverters(Converters.class) //sauvgarder les donnés dans une base de donée locale
    ...
    @Ignore  // les donné ne sont pas sauvgarder mais calculer automatiquement
    public Integer hp = new SplittableRandom().nextInt(100, maxHP);
    @Ignore
    public Integer atk = new SplittableRandom().nextInt(100, maxATK); //gere un nombre aléatoire+ ameliore la performance des application multi-thread
    @Ignore
...
// information du pokemon afficher d'aprés une api
